...
ABSL_FLAG(
    std::string, auth_server_address, "127.0.0.1:50050", "Auth server address."
);
...
ABSL_FLAG(
    std::string, character_name, "explorer", "Character to use or create."
);
...
ABSL_FLAG(
    ...
    50,
    "Movement input send interval in milliseconds."
);
ABSL_FLAG(
    double, auto_move_seconds, 0.0, "Drive forward automatically for N seconds."
);
ABSL_FLAG(
    bool, debug_pose_trace, false, "Log controlled pawn/body/marker positions."
);
