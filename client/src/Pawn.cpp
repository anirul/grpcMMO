...
namespace grpcmmo::client
{
    namespace
    {
        ...
        )
        {
            ...
            const glm::vec3 forward = NormalizeFacingDirection(
                direction, surface_up, fallback_forward
            );
    ...
    void Pawn::Reconcile(float delta_seconds)
    {
        ...
        {
            const float position_alpha = glm::clamp(
                delta_seconds * kIdlePositionCorrectionRate, 0.0f, 1.0f
            );
