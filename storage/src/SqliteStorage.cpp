...
namespace grpcmmo::storage
{
    namespace
    {
        ...
        void BindText(
            sqlite3_stmt* statement, int index, const std::string& value
        )
        {
            sqlite3_bind_text(
    ...
    )
    {
        ...
        Statement statement(
            db_,
            "INSERT INTO accounts(account_id, login_name, password, "
            "display_name) "
            "VALUES(?1, ?2, ?3, ?4);"
        );
    ...
    )
    {
        ...
        Statement statement(
            db_,
            "SELECT character_id, account_id, realm_id, name, planet_id, "
            "zone_id, "
    ...
    )
    {
        ...
        sqlite3_bind_int64(
            statement.Get(), 7, static_cast<sqlite3_int64>(now_ms)
        );
    ...
    std::string SqliteStorage::MakeAccountAccessToken(
