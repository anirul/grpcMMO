...
bool HasMatrixNode(const frame::proto::Level& level, const std::string& name)
{
...
bool HasMeshNode(const frame::proto::Level& level, const std::string& name)
{
...
bool HasCameraNode(const frame::proto::Level& level, const std::string& name)
{
...
TEST(PlayerControllerTest, MouseOrbitUsesDragSignsOnlyWhileOrbitButtonIsHeld)
{
    PlayerController controller;
    controller.Init();
